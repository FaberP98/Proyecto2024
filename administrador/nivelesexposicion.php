...
<head>
    ...
    <title>Niveles de exposición</title>
    <?php
...
<body>
    <div class="container-fluid">
        <h1>Lista de niveles de exposición</h1>
    </div>
    <br>
    <div class="container">
        <div>
        ...
        <!-- Tabla para mostrar los niveles de exposición -->
        <div class="table-responsive">
            <table id="tbl_id" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                    // Consulta a la base de datos para obtener los niveles de exposición
                    $nivelexposicion = $con->query("SELECT * FROM tblnivelexposicion");
                    // Iterar sobre los resultados y mostrarlos en la tabla
                    foreach ($nivelexposicion as $ne) {
                        ?>
                        <tr>
                            <td><?php echo $ne['ValorNivelExposicion']; ?></td>
                            <td><?php echo $ne['Nombre']; ?></td>
                            <td><?php echo $ne['Significado']; ?></td>
                        </tr>
                        <?php
                    }
                    ?>
