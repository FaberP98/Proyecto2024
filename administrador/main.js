  ...
  $('#tblusuario').DataTable(
    {
      ...
      ,
      dom:'<"d-flex justify-content-between"lBf>t<"d-flex justify-content-between"rip>',
      buttons:[
          {
          extend:'excelHtml5',
      ...
      pageLength: 7,
      columnDefs: [
          {orderable: false, target: [2,3,4,5]},
          {searchable: false, target: [3,5]},
      ],
  ...
  $('#tbl_four').DataTable(
    {
      ...
      "columns": [
        null, // Numero
        null, // Nombre, Clasificacion
        null, // Descripcion, proceso relacionado
